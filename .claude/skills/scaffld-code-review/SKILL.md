...
description: "Review Scaffld code for quality, security, performance, accessibility, and adherence to project conventions. Use when: reviewing code, checking a PR, auditing files, validating a feature, or asked to 'review', 'check', 'audit', or 'look over' code. Also use after completing a feature to self-review before committing."
context: fork
agent: Explore
allowed-tools: Read, Grep, Glob
---

# Scaffld Code Reviewer

## Overview

Review code for Scaffld (React + Vite + Firebase/Firestore + Tailwind). Focus on security (especially multi-tenancy), code quality, accessibility, and performance.
