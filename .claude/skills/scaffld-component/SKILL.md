---
name: scaffld-component
description: "Create React UI components for Scaffld following brand guidelines, design tokens, and project conventions. Use when: building pages, forms, cards, modals, dashboards, tables, navigation, or any user-facing UI. Triggers: 'create a component', 'build a page', 'add a form', 'new section', 'UI for', or any request involving visual elements, layouts, or interactive features."
---

# Scaffld Component Generator

## Overview

Generate production-ready React components for Scaffld — a field service management platform for home service businesses. Every component must be field-ready: usable in sunlight, with gloves, on a moving truck.

## Tech Stack

- **Framework:** React 18+ with Vite
- **Language:** JavaScript (JSX) — NOT TypeScript
- **Styling:** Tailwind CSS with custom Scaffld theme
...
|-------|---------------|-----|-------|
| Scaffld Teal | `scaffld-teal` | #0EA5A0 | Primary CTAs, links, brand identity |
| Deep Teal | `scaffld-teal-dark` | #087F7A | Hover states, active, depth |
| Frost Mint | `scaffld-mint` | #B2F0ED | Success, light backgrounds, tags |
| Signal Coral | `scaffld-coral` | #F7845E | Alerts, urgency, accent |
| Harvest Amber | `scaffld-amber` | #FFAA5C | Warnings, highlights, secondary accent |
| Midnight | `scaffld-midnight` | #0C1220 | Dark backgrounds, nav |
| Charcoal | `scaffld-charcoal` | #1A2332 | Cards on dark, secondary surfaces |
| Warm Cream | `scaffld-cream` | #FFF9F5 | Light page backgrounds |
| Field Gray | `scaffld-gray` | #6B7280 | Secondary text, borders |
...
│   ├── icons/                  # SVG icon components + Scaffld logos
...
- Hardcode colors — always use Scaffld theme tokens
