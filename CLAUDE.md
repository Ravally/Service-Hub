...
**Domain:** trellio.app | **Tagline:** "Structure your growth."
...
- **Brand:** Use Trellio design tokens (trellio-teal, signal-coral, harvest-amber, midnight, charcoal) — no hardcoded hex, no `bg-gray-*`
...
- **Brand & design system:** [brand/TRELLIO_BRAND.md](brand/TRELLIO_BRAND.md)
...
- **trellio-component** — UI/React component generation with brand tokens
- **trellio-api** — API endpoints & Server Actions
- **trellio-db-migration** — Prisma schema & migrations
- **trellio-code-review** — Code quality audits (security, types, a11y, perf)
- **trellio-design-reference** — HTML mockups & brand reference
