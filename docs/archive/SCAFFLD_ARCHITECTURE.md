# Scaffld - Technical Architecture & Development Guide
...
3. [Scaffld Brand System](#scaffld-brand-system)
...
Scaffld follows a **layered, modular architecture** with clear separation of concerns:
...
## Scaffld Brand System

### Design Philosophy

Scaffld's visual identity is built on **modern sophistication** with a tech-forward, professional aesthetic. The brand system uses a carefully crafted dark-first design language that emphasizes clarity, hierarchy, and purposeful use of color.

### Color Palette

**Primary Colors**:
```css
/* Scaffld Teal - Primary brand color for actions, accents, and success states */
--scaffld-teal:       #0EA5A0
--scaffld-teal-deep:  #087F7A  /* Hover/active states */
--scaffld-teal-light: #B2F0ED  /* Subtle backgrounds */
...
<div className="bg-charcoal rounded-xl border border-slate-700/30 shadow-sm overflow-hidden hover:border-scaffld-teal/30 transition-all">
...
<input
  type="text"
  className="w-full px-4 py-2.5 bg-midnight border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:border-scaffld-teal focus:ring-2 focus:ring-scaffld-teal/20 transition-all"
...
/* Examples:
   - Approved: scaffld-teal with teal background
...
- Use `scaffld-teal` for positive actions and success states
...
- Don't use green/blue/red for buttons (use Scaffld palette)
- Don't forget hover states and transitions

### Brand Assets

**Logo Components**:
- `ScaffldLogo` - Full logo with icon and text
- `ScaffldLogoIcon` - Icon only
- `ScaffldLogoText` - Wordmark only
...
/* Full logo */
<ScaffldLogo size="md" showText={true} />

/* Icon only */
<ScaffldLogo size="sm" showText={false} />
```
...
- Scaffld teal on dark: ≥4.5:1 contrast ratio
- Large text (18px+): ≥3:1 contrast ratio

### Reference

For complete brand specifications, see:
- [brand/SCAFFLD_BRAND.md](../brand/SCAFFLD_BRAND.md) - Full brand guide
...
│   └── package.json
├── brand/                           # Brand system
│   ├── SCAFFLD_BRAND.md            # Complete brand specification
│   ├── README.md                    # Brand quick reference
│   ├── tokens.css                   # CSS custom properties
│   ├── tokens.json                  # JSON tokens
│   └── tailwind.config.js           # Tailwind theme
├── docs/                            # Documentation
│   ├── SCAFFLD_MASTER_ROADMAP.md   # Master roadmap
│   ├── SCAFFLD_ARCHITECTURE.md     # This file
...
**Next Steps**:
- Review [SCAFFLD_MASTER_ROADMAP.md](SCAFFLD_MASTER_ROADMAP.md) for product direction
