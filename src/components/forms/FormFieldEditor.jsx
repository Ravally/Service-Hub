  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-slate-100">Field Settings</h3>
        <button
          onClick={onClose}
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 p-3 bg-midnight/60 rounded-md">
            <span className="text-xl">{metadata?.icon}</span>
            <span className="text-sm text-slate-100">{metadata?.label}</span>
          </div>
        </div>
        ...
        {metadata?.supportsValidation && (
          <div>
            <h4 className="text-sm font-semibold text-slate-300 mb-2">Validation</h4>
