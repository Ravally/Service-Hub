        ...
        <form onSubmit={handleSaveSettings}>
          <div className={sectionCls}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div><label className={labelCls}>Account Name</label><input type="text" value={companySettings.invoiceBankDetails?.accountName || ''} onChange={e => csn('invoiceBankDetails', { accountName: e.target.value })} className={inputCls} placeholder="e.g., Trellio Ltd" /></div>
